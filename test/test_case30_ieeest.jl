...
raw_file = joinpath(TEST_FILES_DIR, "benchmarks/psse/IEEEST/ThreeBusMulti.raw")
dyr_file = joinpath(TEST_FILES_DIR, "benchmarks/psse/IEEEST/ThreeBus_IEEEST.dyr")
#csv_file = joinpath(TEST_FILES_DIR, "benchmarks/psse/IEEEST/IEEEST_TEST.csv")
...
@testset "Test 30 IEEEST ResidualModel" begin
    ...
    try
        ...
        for (k, v) in test_psse_ieeest_init
        ...
        # Test Eigenvalues
        @test LinearAlgebra.norm(eigs - test30_eigvals) < 1e-3
