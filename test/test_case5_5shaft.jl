...
branch_case5 = [
    PSY.Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case5[1], to = nodes_case5[2]),
        0.01,
        0.05,
        (from = 0.0, to = 0.0),
        100,
    ...
    PSY.Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case5[2], to = nodes_case5[3]),
        0.02,
        0.1,
        (from = 0.0, to = 0.0),
        100,
    ...
    PSY.Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case5[1], to = nodes_case5[3]),
        0.02,
        0.1,
        (from = 0.0, to = 0.0),
        100,
...
case5_machine = PSY.OneDOneQMachine(
    0.0, #R
    1.3125, #Xd
    1.2578, #Xq
    0.1813, #Xd_p
