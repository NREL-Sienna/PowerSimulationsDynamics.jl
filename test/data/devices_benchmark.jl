...
case2_machine3 = OneDOneQMachine(
    0.0, #R
    1.3125, #Xd
    1.2578, #Xq
    0.1813, #Xd_p
...
case3_machine2 = SimpleMarconatoMachine(
    0.0,
    1.3125, #Xd
    1.2578, #Xq
    0.1813, #Xd_p
...
case3_machine3 = SimpleMarconatoMachine(
    0.0,
    1.3125, #Xd
    1.2578, #Xq
    0.1813, #Xd_p
...
case4_machine2 = MarconatoMachine(
    0.0,
    1.3125, #Xd
    1.2578, #Xq
    0.1813, #Xd_p
...
### Shaft for Case 1 ###
case1_shaft = SingleMass(
    3.148, #H
    2.0,
) #D

### Shafts for Gens 2 and 3: Cases 2, 3 and 4 ###
case234_shaft2 = SingleMass(
    3.01, #H (M = 6.02 -> H = M/2)
    0.0,
) #D

case234_shaft3 = SingleMass(
    3.01, #H (M = 6.02 -> H = M/2)
    0.0,
) #D

case5_shaft = FiveMassShaft(
    3.01, #5.148, #H
    0.3348, #H_hp
    0.7306, #H_ip
    0.8154, #H_lp
...
### Case 1 Generator ###
case1_gen = PSY.DynamicGenerator(
    1, #Number
    :Case1Gen,
    nodes_case1[2], #bus
    1.0, # ω_ref,
...
case2_gen3 = PSY.DynamicGenerator(
    2, #Number
    :Case2Gen3,
    nodes_case234[3], #bus
    1.0, # ω_ref,
...
### Case 3 Generators ###
case3_gen2 = PSY.DynamicGenerator(
    1, #Number
    :Case3Gen2,
    nodes_case234[2], #bus
    1.0, # ω_ref,
...
case3_gen3 = PSY.DynamicGenerator(
    2, #Number
    :Case3Gen3,
    nodes_case234[3], #bus
    1.0, # ω_ref,
...
case4_gen3 = PSY.DynamicGenerator(
    2, #Number
    :Case4Gen3,
    nodes_case234[3], #bus
    1.0, # ω_ref,
...
### Case 5 Generator ###
case5_gen = PSY.DynamicGenerator(
    1, #Number
    :Case5Gen,
    nodes_case5[2], #bus
    1.0, # ω_ref,
