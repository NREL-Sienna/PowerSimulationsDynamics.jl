...
branch_case8 = [
    Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case8[1], to = nodes_case8[3]),
        0.01,
        0.12,
        (from = 0.1, to = 0.1),
        100,
    ...
    Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case8[1], to = nodes_case8[2]),
        0.01,
        0.12,
        (from = 0.1, to = 0.1),
        100,
    ...
    Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case8[2], to = nodes_case8[3]),
        0.02,
        0.9,
        (from = 0.5, to = 0.5),
        100,
...
loads_case8 = [
    PowerLoad("Bus1", true, nodes_case8[1], PowerSystems.ConstantPower, 0.5, 0.1, 1.5, 0.8),
...
### Case 7 Generators ###
case8_gen = PSY.DynamicGenerator(
    1, #Number
    :Case8Gen,
    nodes_case8[2], #bus
    1.0, # ω_ref,
...
case8_DynSystem = PSY.System(
    nodes_case8,
    branch_case8,
    [case8_inv, case8_gen],
    vcat(inf_gen_case8, loads_case8),
    100.0,
    50.0,
);
...
sim = Simulation(case8_DynSystem, tspan, Ybus_fault, cb, x0_init)
