...
dx0 = zeros(LITS.get_total_rows(case3_DynSystem))
...
inif! = (out,x) -> LITS.system_model!(out, dx0 ,x, (Ybus_fault,case3_DynSystem), 0.0)
...
sim = DynamicSimulation(case3_DynSystem, tspan, Ybus_fault, cb, x0_init)
