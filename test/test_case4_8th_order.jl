...
branch_case234 = [
    PSY.Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case234[1], to = nodes_case234[3]),
        0.01,
        0.12,
        (from = 0.0, to = 0.0),
        100,
    ...
    PSY.Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case234[1], to = nodes_case234[2]),
        0.01,
        0.12,
        (from = 0.0, to = 0.0),
        100,
    ...
    PSY.Line(
        ...
        0.0,
        0.0,
        Arc(from = nodes_case234[2], to = nodes_case234[3]),
        0.01,
        0.12,
        (from = 0.0, to = 0.0),
        100,
...
case4_machine2 = PSY.MarconatoMachine(
    0.0,
    1.3125, #Xd
    1.2578, #Xq
    0.1813, #Xd_p
...
case4_machine3 = PSY.MarconatoMachine(
    0.0,
    1.3125, #Xd
    1.2578, #Xq
    0.1813, #Xd_p
...
case234_shaft2 = PSY.SingleMass(
    3.01, #H (M = 6.02 -> H = M/2)
    0.0,
) #D

case234_shaft3 = PSY.SingleMass(
    3.01, #H (M = 6.02 -> H = M/2)
    0.0,
) #D
...
#Add generators
PSY.add_component!(sys, case4_gen2)
PSY.add_component!(sys, case4_gen3)
