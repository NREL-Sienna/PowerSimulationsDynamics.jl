...
Basic = PSY.BaseMachine(   0.0, #R
                       0.2995, #Xd_p
                       1.05, #eq_p
                       615.0)  #MVABase
@test Basic isa PSY.DynamicComponent

oneDoneQ = PSY.OneDOneQMachine(0.0, #R
                        0.8979, #Xd
                        0.646, #Xq
                        0.2995, #Xd_p
                        0.04, #Xq_p
...
AndersonFouad = PSY.AndersonFouadMachine(0.0, #R
                        0.8979, #Xd
                        0.646, #Xq
                        0.2995, #Xd_p
                        0.646, #Xq_p
...
KundurMachine = PSY.SimpleFullMachine(0.003, #R on Example 3.1 and 4.1 of Kundur
                                  0.0006, #R_f
...
KundurFullMachine = PSY.FullMachine(0.003, #R on Example 3.1 and 4.1 of Kundur
                                0.0006, #R_f
                                #0.003, #R_f
                                0.0284, #R_1d or RD in Machowski
                                0.0062, #R_1q or RQ on Machowski
...
Mach2_benchmark = PSY.OneDOneQMachine(0.0, #R
                        1.3125, #Xd
                        1.2578, #Xq
                        0.1813, #Xd_p
                        0.25, #Xq_p
...
BaseShaft = PSY.SingleMass(5.148, #H
                       2.0) #D
@test BaseShaft isa PSY.DynamicComponent

FiveShaft = PSY.FiveMassShaft(5.148,  #H
                          0.3348, #H_hp
                          0.7306, #H_ip
                          0.8154, #H_lp
                          0.0452, #H_ex,
...
typeI_avr = PSY.AVRTypeI(200.0, #Ka
                     1.0, #Ke
                     0.0012, #Kf
                     0.02, #Ta
                     0.19, #Te
...
gen2_avr_benchmark = PSY.AVRTypeII(20.0, #K0 - Gain
                     0.2, #T1 - 1st pole
                     0.063, #T2 - 1st zero
                     0.35, #T3 - 2nd pole
                     0.01, #T4 - 2nd zero
