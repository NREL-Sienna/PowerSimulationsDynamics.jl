...
@testset "Dynamic Machines" begin
    ...
    AndersonFouad = PSY.AndersonFouadMachine(
        0.0, #R
        0.8979, #Xd
        0.646, #Xq
        0.2995, #Xd_p
    ...
    KundurMachine = PSY.SimpleFullMachine(
    ...
    Mach2_benchmark = PSY.OneDOneQMachine(
        0.0, #R
        1.3125, #Xd
        1.2578, #Xq
        0.1813, #Xd_p
...
@testset "Dynamic AVR Constructors" begin
    ...
    gen2_avr_benchmark = PSY.AVRTypeII(
        20.0, #K0 - Gain
        0.2, #T1 - 1st pole
        0.063, #T2 - 1st zero
        0.35, #T3 - 2nd pole
